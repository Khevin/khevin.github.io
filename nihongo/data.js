...
window.VOCAB_CLASSES = [
  {
    ...
    books: [
          ...
          { id:'yasai', kanji:'野菜', kana:'やさい', romaji:'yasai',
            ...
            items: [
              ...
              { id:'negi', kanji:'葱', kana:'ねぎ', romaji:'negi', en:'Japanese leek',
                flavors:['sawayaka'], textures:['シャキシャキ'], season:['冬 winter'],
                notes:'Long white leek-onion hybrid. Sliced into ramen, in miso soup, as a yakitori component (ねぎま — alternating chicken + leek on the skewer), or grilled whole and dipped in tare. The green tops bring a fresh, slightly grassy bite — a topping that wakes up rather than burns, which puts negi closer to さわやか than to 辛い.' },
      ...
      { id:'textures', titleJa:'しょっかん', titleEn:'Textures', glyph:'食感', primaryLevel:'N4', pages:[],
        ...
        // stapleLabel (one-word English mnemonic), softness (1-10
        // position on the soft→hard axis), feelsLike (5 adjective
        // pills), moods (4 mood-icon chips). Brief: PRODUCT.md §7.2.
        // Textures are sorted in seed order; the spectrum component
        // re-sorts by `softness` at render time.
        textures:[
          { id:'mochimochi', kana:'もちもち', kanji:'', romaji:'mochimochi',
            ...
            moods:[
              ...
              { icon:'heart',  label:'安心' },
              { icon:'gift',   label:'ごほうび' },
              { icon:'sakura', label:'やさしい時間' },
            ],
            audioFoley:'soft squish / chewy-press',
            // notesJa: simple two-sentence Japanese for the spotlight
            // card (immersion). English version stays in `notes` for
            // the bottom drawer. Pattern across all 10 textures:
            //   「KANA」は ~ かんじです。  ← what it feels like
            //   FOOD や FOOD は KANA しています。  ← real examples
            // Grammar held to N5-N4 (は particle, です/する copulas,
            // ような comparative, かんじ noun, basic adjectives).
            notesJa:'「もちもち」は やわらかくて、はずむ かんじです。 おもち や しょくパン は もちもち しています。',
          ...
          { id:'sakusaku', kana:'さくさく', kanji:'',  romaji:'sakusaku',
            ...
            moods:[
              ...
              { icon:'sun',    label:'楽しい' },
              { icon:'gift',   label:'おやつ' },
              { icon:'leaf',   label:'さわやか' },
            ],
            audioFoley:'crisp shatter / batter-snap',
            notesJa:'「さくさく」は かるくて、くずれる かんじです。 クッキー や てんぷら は さくさく しています。',
          ...
          { id:'nebaneba', kana:'ねばねば', kanji:'',  romaji:'nebaneba',
            ...
            staple:'nattou', stapleLabel:'sticky', softness:4,
            foodPool:['nattou','youkan','mochi','daifuku','warabimochi','anmitsu'],
            feelsLike:['sticky','stringy','粘り','健康','日本らしい'],
            moods:[
              { icon:'leaf',   label:'健康' },
              { icon:'sun',    label:'朝食' },
              { icon:'sparkbig',label:'元気' },
              { icon:'cup',    label:'毎日のごはん' },
            ],
            audioFoley:'wet stretch / stringy pull',
            notesJa:'「ねばねば」は ねばって、いとを ひく かんじです。 なっとう や おくら は ねばねば しています。',
          ...
          { id:'paripari',  kana:'ぱりぱり', kanji:'',  romaji:'paripari',
            ...
            moods:[
              ...
              { icon:'sun',    label:'楽しさ' },
              { icon:'leaf',   label:'さわやか' },
              { icon:'gift',   label:'ちょっと贅沢' },
            ],
            audioFoley:'thin snap / sheet-crack',
            notesJa:'「ぱりぱり」は うすくて、ぱりっと わる かんじです。 のり や ポテトチップス は ぱりぱり しています。',
          ...
          { id:'sarasara',  kana:'さらさら', kanji:'',  romaji:'sarasara',
            ...
            moods:[
              { icon:'drop',   label:'清涼' },
              { icon:'leaf',   label:'すっきり' },
              { icon:'sakura', label:'静かな時間' },
              { icon:'cup',    label:'お茶' },
            ],
            audioFoley:'gentle pour / brushed silk',
            notesJa:'「さらさら」は さらりと、ながれる かんじです。 おちゃ や みず は さらさら しています。',
          ...
          { id:'fuwafuwa',  kana:'ふわふわ', kanji:'',  romaji:'fuwafuwa',
            ...
            moods:[
              ...
              { icon:'sakura', label:'朝の光' },
              { icon:'heart',  label:'幸せ' },
              { icon:'gift',   label:'おやつ' },
            ],
            audioFoley:'soft puff / cotton-press',
            notesJa:'「ふわふわ」は くうきの ように、かるい かんじです。 ホットケーキ や しょくパン は ふわふわ しています。',
          ...
          { id:'torotoro',  kana:'とろとろ', kanji:'',  romaji:'torotoro',
            ...
            moods:[
              { icon:'heart',  label:'幸せ' },
              { icon:'gift',   label:'贅沢' },
              { icon:'sparkbig',label:'至福' },
              { icon:'cup',    label:'朝ごはん' },
            ],
            audioFoley:'thick pour / honey-drag',
            notesJa:'「とろとろ」は とけるように、なめらかな かんじです。 たまご や バター は とろとろ しています。',
          ...
          { id:'shakishaki',kana:'シャキシャキ', kanji:'',romaji:'shakishaki',
            ...
            moods:[
              ...
              { icon:'sun',    label:'健康' },
              { icon:'drop',   label:'みずみずしい' },
              { icon:'sparkbig',label:'元気' },
            ],
            audioFoley:'vegetable snap / leaf-crunch',
            notesJa:'「シャキシャキ」は しんせんで、パリッと した かんじです。 キャベツ や れんこん は シャキシャキ しています。',
          ...
          { id:'puripuri',  kana:'ぷりぷり', kanji:'',  romaji:'puripuri',
            ...
            moods:[
              { icon:'drop',   label:'鮮度' },
              { icon:'spark',  label:'食べごたえ' },
              { icon:'heart',  label:'喜び' },
              { icon:'gift',   label:'ご褒美' },
            ],
            audioFoley:'plump-pop / sausage-bite',
            notesJa:'「ぷりぷり」は はずむように、はりのある かんじです。 えび や たこ は ぷりぷり しています。',
          ...
          { id:'karikari',  kana:'カリカリ', kanji:'',  romaji:'karikari',
            ...
            moods:[
              { icon:'gift',   label:'ご褒美' },
              { icon:'spark',  label:'食べごたえ' },
              { icon:'heart',  label:'楽しさ' },
              { icon:'sparkbig',label:'満足' },
            ],
            audioFoley:'hard crunch / bacon-snap',
            notesJa:'「カリカリ」は かたくて、おとが する かんじです。 フライドチキン や ベーコン は カリカリ しています。',
