        ...
        pages: [
          {
            ...
            imageSlotId: 'sheet-ono-1',
            items: [
              { num:1,  kanji:'にこにこ',     kana:'にこにこ',     en:'smiling, beaming' },
              { num:2,  kanji:'ぽよぽよ',     kana:'ぽよぽよ',     en:'soft and squishy' },
              { num:3,  kanji:'ちくちく',     kana:'ちくちく',     en:'prickly, stinging' },
              { num:4,  kanji:'ふにゃふにゃ', kana:'ふにゃふにゃ', en:'floppy, limp' },
              { num:5,  kanji:'くすくす',     kana:'くすくす',     en:'giggling, snickering' },
              { num:6,  kanji:'にゃーにゃー', kana:'にゃーにゃー', en:'meow meow' },
              { num:7,  kanji:'ぴたり',       kana:'ぴたり',       en:'exactly right / stopping dead' },
              { num:8,  kanji:'ぴょんぴょん', kana:'ぴょんぴょん', en:'hopping, bouncing' },
              { num:9,  kanji:'ぽたぽた',     kana:'ぽたぽた',     en:'drip drip' },
              { num:10, kanji:'コロコロ',     kana:'ころころ',     en:'rolling, tumbling' },
            ]
          },
          {
            id: 'usage',
            type: 'usage',
            title: 'つかいかた',
            subtitle: 'How onomatopoeia attach to verbs and adjectives',
            items: [
              { ja:'にこにこ笑う',       kana:'にこにこ わらう',       en:'to smile broadly' },
              { ja:'ぽよぽよした肌',     kana:'ぽよぽよ した はだ',    en:'soft, squishy skin' },
              { ja:'ちくちく痛い',       kana:'ちくちく いたい',       en:'to sting / prickle' },
              { ja:'ふにゃふにゃになる', kana:'ふにゃふにゃ に なる',  en:'to go all floppy' },
              { ja:'くすくす笑う',       kana:'くすくす わらう',       en:'to giggle' },
              { ja:'猫がにゃーにゃー鳴く',kana:'ねこが にゃーにゃー なく',en:'the cat meows' },
              { ja:'答えがぴたりと合う', kana:'こたえが ぴたりと あう', en:'the answer fits exactly' },
              { ja:'うさぎがぴょんぴょん跳ぶ',kana:'うさぎが ぴょんぴょん とぶ',en:'the rabbit hops around' },
              { ja:'水がぽたぽた落ちる', kana:'みずが ぽたぽた おちる', en:'water drips down' },
              { ja:'ボールがコロコロ転がる', kana:'ぼーるが ころころ ころがる', en:'the ball rolls along' },
            ]
          },
          {
            id: 'sentences',
            type: 'sentences',
            title: 'ぶん',
            subtitle: 'Onomatopoeia in real sentences',
            items: [
              { ja:'赤ちゃんが にこにこ 笑って います。',
                en:'The baby is smiling happily.', level:'N5' },
              { ja:'猫が にゃーにゃー 鳴いて いるよ。',
                en:'The cat is meowing, you know.', level:'N5' },
              { ja:'蛇口から 水が ぽたぽた 落ちて います。',
                en:'Water is dripping from the faucet.', level:'N5' },
              { ja:'このクッション、ぽよぽよ して 気持ちいい。',
                en:'This cushion is soft and squishy — feels nice.', level:'N4' },
              { ja:'セーターが ちくちく して、かゆい。',
                en:'The sweater is prickly and itchy.', level:'N4' },
              { ja:'みんなが くすくす 笑って いたので、恥ずかしく なった。',
                en:'Everyone was giggling, so I got embarrassed.', level:'N4' },
              { ja:'うさぎが 庭を ぴょんぴょん 跳んで いた。',
                en:'A rabbit was hopping around the garden.', level:'N4' },
              { ja:'暑さで アイスが ふにゃふにゃに なって しまった。',
                en:'The ice cream went all floppy from the heat.', level:'N3' },
              { ja:'計算が ぴたりと 合った とき、うれしかった。',
...
window.FLASHCARD_CLASSES = [
  {
    ...
    cards: [
      ...
      { id:'life',      kanji:'生', kun:'い',     on:'セイ',   en:'life / give birth', strokes:5, examples:[{word:'生活',reading:'SEIKATSU',meaning:'daily life'},{word:'先生',reading:'SENSEI',meaning:'teacher'},{word:'生まれる',reading:'umareru',meaning:'to be born'}] },
  ...
  },
  {
    ...
    cards: [
      ...
      // weather (4 seasons + sky cluster moved to Nature 2; 犬・貝 to Animals)
      ...
      { id:'flame',    kanji:'炎', kun:'ほのお', on:'エン',   en:'flame / blaze',
        strokes:8,
        notes:'Two 火 (fire) stacked — visually doubled fire = a roaring blaze. Often used figuratively for passion or inflammation.',
        examples:[{word:'火炎',reading:'KAEN',meaning:'flame / blaze'},{word:'炎症',reading:'ENSHŌ',meaning:'inflammation'},{word:'炎天',reading:'ENTEN',meaning:'scorching sky / blazing heat'}] },
  ...
  },
  {
    ...
    cards: [
      ...
      // Radical card — 手 collapses into two distinct shapes when riding
      // inside compound kanji: the ヨ-like comb (top, middle, or bottom) and
      // the ナ-like wedge (small overlay). Both still mean "hand doing
      // something". 6 examples — first 4 show the ヨ-form, last 2 show the
      // ナ-form. 录 is a component, not a standalone Japanese kanji, so its
      // kun is left blank; ロク is its compound reading (e.g. 録).
      { id:'hand-radical', type:'radical',
        radical:['ナ', 'ヨ'], from:'手',
        titleJa:'ナ と ヨ', titleEn:'hand radicals (from 手)',
        descEn:'Two compressed forms of 手 (hand). The ヨ-like comb appears on top, middle, or bottom; the ナ-like wedge sits as a small overlay. Both mark kanji where a hand is doing something — squeezing, writing, holding, having.',
        descJa:'「手」の変形が二つ。ヨ のくし の かたちと、ナ の くさび の かたち。どちらも手で何かをすることに かんけい する 漢字につく。',
        examples:[
          { kanji:'录', kun:'',       on:'ロク',   en:'squeeze out (component)' },
          { kanji:'書', kun:'か',     on:'ショ',   en:'write' },
          { kanji:'当', kun:'あた',   on:'トウ',   en:'hit the target / apply' },
          { kanji:'雪', kun:'ゆき',   on:'セツ',   en:'snow' },
          { kanji:'有', kun:'あ',     on:'ユウ',   en:'have / exist' },
          { kanji:'佐', kun:'',       on:'サ',     en:'assist / help' },
        ] },
      ...
      // Relocated from old `body2` class (Task 1). Final ordering set in Task 6.
  ...
  },
  {
    ...
    cards: [
      ...
      { id:'yellow',   kanji:'黄色', kun:'きいろ',    on:'',       en:'yellow', swatch:'#d4a017',
        notes:'黄色 [kiiro] is a compound: 黄 [ki] (yellow) + 色 [iro] (color). The i-adjective form is 黄色い [kiiroi].',
        examples:[{word:'黄色い花',reading:'kiiroi hana',meaning:'yellow flower'},{word:'黄金',reading:'ŌGON',meaning:'gold / golden'}] },
      ...
      { id:'brown',    kanji:'茶色', kun:'ちゃいろ',  on:'',       en:'brown (tea-colored)', swatch:'#8b6340',
        notes:'茶色 [chairo] is a compound: 茶 [cha] (tea) + 色 [iro] (color) — literally "tea color." The i-adjective form is 茶色い [chairoi].',
        examples:[{word:'茶色い犬',reading:'chairoi inu',meaning:'brown dog'},{word:'茶色い髪',reading:'chairoi kami',meaning:'brown hair'}] },
      ...
      { id:'orange',   kanji:'オレンジ', kun:'おれんじ', on:'',  en:'orange', swatch:'#e06820', alt:'橙色 だいだいいろ',
        notes:'オレンジ [orenji] from English is the everyday word. The native 橙色 [daidaiiro] — 橙 [daidai] (bitter orange) + 色 [iro] (color) — is the formal/literary form.',
        examples:[{word:'オレンジ色',reading:'orenji iro',meaning:'orange color'},{word:'オレンジジュース',reading:'orenji jūsu',meaning:'orange juice'}] },
      { id:'pink',     kanji:'ピンク', kun:'ぴんく', on:'',      en:'pink', swatch:'#e06088', alt:'桃色 ももいろ',
        notes:'ピンク [pinku] from English is the everyday word. The native 桃色 [momoiro] — 桃 [momo] (peach) + 色 [iro] (color) — is more literary.',
        examples:[{word:'ピンク色',reading:'pinku iro',meaning:'pink color'},{word:'桃色の花',reading:'momoiro no hana',meaning:'pink flower'}] },
      { id:'gray',     kanji:'灰色', kun:'はいいろ', on:'',      en:'gray', swatch:'#6e6e6e', alt:'グレー ぐれー',
        notes:'灰色 [haiiro] is 灰 [hai] (ash) + 色 [iro] (color) — literally "ash color." グレー [gurē] from English is equally common in daily speech.',
        examples:[{word:'灰色の空',reading:'haiiro no sora',meaning:'gray sky'},{word:'グレーのスーツ',reading:'gurē no sūtsu',meaning:'gray suit'}] },
      { id:'lightblue', kanji:'水色', kun:'みずいろ', on:'',     en:'light blue', swatch:'#5ba4d9',
        notes:'水色 [mizuiro] is 水 [mizu] (water) + 色 [iro] (color) — literally "water color." A distinct color from 青 [ao] (blue), closer to sky or aqua.',
        examples:[{word:'水色の空',reading:'mizuiro no sora',meaning:'light blue sky'},{word:'水色のドレス',reading:'mizuiro no doresu',meaning:'light blue dress'}] },
    ],
  },
  {
    id: 'school',
    ...
    cards: [
      ...
      // Radical card — the brush radical 聿. No `from` field: 聿 isn't a
      // compressed variant of another kanji like 亻 or ナ. It's its own
      // ideogram (a hand holding a brush) that survives as the top of 書
      // and the inside of 筆. The two example cards that follow (書, 筆)
      // are the cards this radical lecture sets up.
      { id:'brush-radical', type:'radical',
        radical:'聿',
        titleJa:'ふでづくり', titleEn:'brush radical',
        descEn:'A hand (ヨ) gripping a painting brush (丨) drawing two strokes (二). In 書 it sits above 日 (paper) — hand-and-brush writes on the page. In 筆 it sits under 竹 (bamboo) — a brush made of bamboo. Marks kanji about writing, ruling, and laying things down.',
        descJa:'「聿」 は ふで を にぎる 手 の かたち。「ヨ」 が 手、「丨」 が ふで、「二」 が 書いた 線。「書」 の うえ に あり、「筆」 の なか に ある。書くこと、おさめること に かんけい する 漢字 に つく。',
        examples:[
          { kanji:'書', kun:'か',    on:'ショ',  en:'write / book' },
          { kanji:'筆', kun:'ふで',  on:'ヒツ',  en:'brush / handwriting' },
          { kanji:'律', kun:'',      on:'リツ',  en:'law / rhythm' },
          { kanji:'建', kun:'た',    on:'ケン',  en:'build / construct' },
        ] },
      ...
      { id:'brush',    kanji:'筆', kun:'ふで',     on:'ヒツ',   en:'brush / handwriting',
        seeAlso:['書','竹'],
        strokes:12,
        examples:[
          {word:'鉛筆',reading:'ENPITSU',meaning:'pencil'},
          {word:'筆記',reading:'HIKKI',meaning:'writing / note-taking'},
          {word:'毛筆',reading:'MŌHITSU',meaning:'calligraphy brush'},
        ] },
  ...
  },
  {
    ...
    titleEn: 'Time',
    glyph: '時',
    // Order: anchor on now → today/yesterday pair → expand by week/month/year
    // with year pairing to last-year. Then 先 (the "ahead/previous" anchor)
    // and 先生 as a frozen idiom. Then daily-rhythm pairs (early/late,
    // noon/evening), and finally the clock face (hour, minute, second).
    // 日 and 月 already live in Basic so they're not repeated here.
    cards: [
      { id:'now',      kanji:'今', kun:'いま',     on:'コン',   en:'now / present', strokes:4,
        examples:[{word:'今すぐ',reading:'ima sugu',meaning:'right now'},{word:'今夜',reading:'KONYA',meaning:'tonight'},{word:'今度',reading:'KONDO',meaning:'next time / this time'}] },
      { id:'today',    kanji:'今日', kun:'きょう', on:'',       en:'today',
        notes:'今 (kon, now) + 日 (nichi, day) — "the day that is now." Irregular reading: both kanji collapse into きょう as a single sound (jukujikun).',
        examples:[{word:'今日は',reading:'konnichi wa',meaning:'hello (lit. "as for today")'},{word:'今日中に',reading:'kyō jū ni',meaning:'by end of today'},{word:'今日の天気',reading:'kyō no tenki',meaning:"today's weather"}] },
      { id:'yesterday',kanji:'昨日', kun:'きのう', on:'',       en:'yesterday',
        notes:'昨 (saku, previous) + 日 (nichi, day). Pronounced きのう as a jukujikun reading — neither kanji takes its usual sound. Formal speech sometimes uses SAKUJITSU.',
        examples:[{word:'昨日の夜',reading:'kinō no yoru',meaning:'last night'},{word:'昨日から',reading:'kinō kara',meaning:'since yesterday'},{word:'一昨日',reading:'ototoi',meaning:'day before yesterday'}] },
      { id:'thisweek', kanji:'今週', kun:'こんしゅう', on:'',   en:'this week',
        notes:'今 (kon, now) + 週 (shū, week). Pair with 先週 (senshū, last week) and 来週 (raishū, next week).',
        examples:[{word:'今週中に',reading:'konshū jū ni',meaning:'by end of this week'},{word:'今週末',reading:'konshū matsu',meaning:'this weekend'},{word:'今週の予定',reading:'konshū no yotei',meaning:"this week's schedule"}] },
      { id:'thismonth',kanji:'今月', kun:'こんげつ', on:'',     en:'this month',
        notes:'今 (kon, now) + 月 (getsu, month). Pair with 先月 (sengetsu, last month) and 来月 (raigetsu, next month).',
        examples:[{word:'今月から',reading:'kongetsu kara',meaning:'starting this month'},{word:'今月末',reading:'kongetsu matsu',meaning:'end of this month'},{word:'今月の予定',reading:'kongetsu no yotei',meaning:"this month's schedule"}] },
      { id:'thisyear', kanji:'今年', kun:'ことし', on:'',       en:'this year',
        notes:'今 (kon, now) + 年 (nen, year), but read as ことし — a jukujikun (idiomatic) reading where neither kanji takes its usual sound.',
        examples:[{word:'今年の夏',reading:'kotoshi no natsu',meaning:"this year's summer"},{word:'今年中に',reading:'kotoshi jū ni',meaning:'within this year'},{word:'今年も',reading:'kotoshi mo',meaning:'this year too'}] },
      { id:'lastyear', kanji:'去年', kun:'きょねん', on:'',     en:'last year',
        notes:'去 (kyo, past / leave) + 年 (nen, year) — "the year that passed." Pair with 今年 (kotoshi, this year) and 来年 (rainen, next year).',
        examples:[{word:'去年の夏',reading:'kyonen no natsu',meaning:"last year's summer"},{word:'去年から',reading:'kyonen kara',meaning:'since last year'},{word:'去年の今頃',reading:'kyonen no imagoro',meaning:'around this time last year'}] },
      { id:'come',     kanji:'来', kun:'く',       on:'ライ',   en:'come / next / future', strokes:7,
        notes:'The verb 来る (kuru, "to come") is one of the two irregular verbs in Japanese — the stem changes (く・き・こ) by tense. As a prefix, ライ marks "next/coming" (来週, 来月, 来年).',
        examples:[{word:'来る',reading:'kuru',meaning:'to come'},{word:'未来',reading:'MIRAI',meaning:'future'},{word:'将来',reading:'SHŌRAI',meaning:'future (career)'}] },
      { id:'nextyear', kanji:'来年', kun:'らいねん', on:'',     en:'next year',
        notes:'来 (rai, coming) + 年 (nen, year) — "the year that is coming." Closes the year triplet: 去年 (last year) → 今年 (this year) → 来年 (next year). The same 来 prefix gives 来週 (next week) and 来月 (next month).',
        examples:[{word:'来年の春',reading:'rainen no haru',meaning:"next year's spring"},{word:'来年から',reading:'rainen kara',meaning:'starting next year'},{word:'また来年',reading:'mata rainen',meaning:'see you next year'}] },
      ...
      { id:'sensei',   kanji:'先生', kun:'せんせい', on:'',     en:'teacher / doctor / master',
        notes:'先 (sen, ahead) + 生 (sei, life) — "one born ahead in life." The honorific for teachers, doctors, professors, and respected experts. Used after a name (Tanaka-sensei).',
        examples:[{word:'学校の先生',reading:'gakkō no sensei',meaning:'school teacher'},{word:'先生に聞く',reading:'sensei ni kiku',meaning:'to ask the teacher'},{word:'お医者さん',reading:'oishasan',meaning:'doctor (also called sensei)'}] },
      ...
      { id:'second',   kanji:'秒', kun:'',         on:'ビョウ', en:'second (of time)', strokes:9,
        examples:[{word:'一秒',reading:'ICHIBYŌ',meaning:'one second'},{word:'秒針',reading:'BYŌSHIN',meaning:'second hand (of clock)'},{word:'数秒',reading:'SŪBYŌ',meaning:'a few seconds'}] },
    ],
  },
  {
    id: 'directions',
  ...
  },
  {
    ...
    cards: [
      ...
      { id:'bird',      kanji:'鳥', kun:'とり',       on:'チョウ', en:'bird', strokes:11,
        examples:[{word:'白鳥',reading:'HAKUCHŌ',meaning:'swan'},{word:'鳥居',reading:'torii',meaning:'shrine gate'},{word:'焼き鳥',reading:'yakitori',meaning:'grilled chicken skewer'}] },
      { id:'smallbird', kanji:'小鳥', kun:'ことり',    on:'',       en:'small bird / songbird',
        notes:'小鳥 [kotori] is 小 [ko] (small) + 鳥 [tori] (bird). The rendaku voices と→ど in compounds, but here it stays ことり.',
        examples:[{word:'小鳥のさえずり',reading:'kotori no saezuri',meaning:'birdsong'},{word:'小鳥を飼う',reading:'kotori o kau',meaning:'to keep a small bird'}] },
